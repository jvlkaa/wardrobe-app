...
/* When using h:selectOneRadio, the value of styleClass is not added to the input (when using group attribute it is ignored).
 This function adds form-check-input CSS class to each radio input */
function fixRadio() {
